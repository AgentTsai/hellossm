      ...
      <div class="modal-body">
        <form class="form-horizontal" id="emp_Update_form">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="email" class="form-control" id="email_Update_input" placeholder="email@tsai.edu.cn">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="emp_add_form">
		  ...
		  <div class="form-group">
		    <label class="col-sm-2 control-label">email</label>
		    <div class="col-sm-10">
		      <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@tsai.edu.cn">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
...
<script type="text/javascript">
	...
	$("#emp_Update_btn").click(function(){
		...
		$.ajax({
			...
			直接使用PUT方式请求数据更新时，Tomcat并没有封装map，使得更新的数据为NULL。
			要直接使用，需在web.xml中引入org.springframework.web.filter.HttpPutFormContentFilter
			*/
			type:"PUT",
